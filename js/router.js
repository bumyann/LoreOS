...
function renderGetStarted(el) {
  el.innerHTML = `
    <div class="home-hero">
      ...
      <div class="home-footer-note">// built for SillyTavern · JanitorAI · SaucepanAI &nbsp;·&nbsp; all data stays in your browser &nbsp;·&nbsp; <a href="https://loreos.pages.dev/legal.html" target="_blank" style="color:var(--txm);text-decoration:none;border-bottom:1px solid var(--bd)">privacy & terms</a></div>
    </div>
  `;
}
...
function renderDashboard(el) {
  ...
  el.innerHTML = `
    <div class="dashboard">
      ...
      <div class="home-footer-note">// all data stays in your browser &nbsp;·&nbsp; <a href="https://loreos.pages.dev/legal.html" target="_blank" style="color:var(--txm);text-decoration:none;border-bottom:1px solid var(--bd)">privacy & terms</a></div>
    </div>
  `;
